...
public interface SemanticLocations {
   ...
   */
  @Nonnull
  Map<String, List<Location>> references(@Nonnull MyDocumentModel document);
   ...
   */
  @Nonnull
  Map<String, List<Location>> definitions(@Nonnull MyDocumentModel document);
   ...
   */
  boolean containsToken(@Nonnull MyDocumentModel document, @Nonnull String token);
}

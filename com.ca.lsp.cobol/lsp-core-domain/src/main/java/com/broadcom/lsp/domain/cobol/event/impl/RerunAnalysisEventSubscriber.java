...
/** A subscriber for {@link RerunAnalysisEvent} */
@Slf4j
@RequiredArgsConstructor
public class RerunAnalysisEventSubscriber {

  @Getter @NonNull private EventObserver observer;

  @NonNull @Getter private RerunAnalysisEvent eventType;

  @Subscribe
  @AllowConcurrentEvents
  @SneakyThrows
  public void onDataHandler(RerunAnalysisEvent eventType) {

...
public interface CopybookService {
   ...
   */
  void sendCopybookDownloadRequest(Uri documentUri, Collection<Uri> copybookUris, CopybookProcessingMode processingMode);
   ...
   */
  Set<CopybookModel> getCopybookUsage(Uri documentUri);

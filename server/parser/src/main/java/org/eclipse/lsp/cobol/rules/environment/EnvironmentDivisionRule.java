 ...
 *
 */
package org.eclipse.lsp.cobol.rules.environment;

import org.eclipse.lsp.cobol.cst.EnvironmentDivision;
...
public class EnvironmentDivisionRule implements LanguageRule {
  ...
  public boolean tryMatch(ParsingContext ctx, CobolLanguage language) {
    return ctx.matchSeq("ENVIRONMENT", "DIVISION", ".");
  }
}

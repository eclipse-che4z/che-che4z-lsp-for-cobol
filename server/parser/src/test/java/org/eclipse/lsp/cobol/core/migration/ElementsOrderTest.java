...
import static org.eclipse.lsp.cobol.core.migration.SectionCompositionTest.antlrParse;
import static org.eclipse.lsp.cobol.core.migration.Utils.compareAll;
import static org.eclipse.lsp.cobol.core.migration.Utils.compareStartStopPositions;
...
class ElementsOrderTest {
  ...
  void case4() {
    ...
    compareAll(antlrPdc, migratedPdc);
    ...
    compareStartStopPositions(antlrP1, migratedP1);
    compareStartStopPositions(antlrP2, migratedP2);
  }
  ...
  void case5() {
    ...
    compareStartStopPositions(antlr2, migrated2);

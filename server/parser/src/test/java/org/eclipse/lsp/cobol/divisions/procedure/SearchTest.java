...
public class SearchTest {
    ...
    String source =
        ...
        // Statement should be nested
        assertEquals(3, result.getSourceUnit().list(Statement.class).get(0).list(Statement.class).size());
        assertEquals(source, result.getSourceUnit().toText());
    }
}

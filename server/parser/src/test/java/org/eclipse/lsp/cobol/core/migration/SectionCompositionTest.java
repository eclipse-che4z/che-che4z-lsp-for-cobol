...
class SectionCompositionTest {
  ...
  void test() {
    ...
    ParseTree antlrPdbP1 = antlrPdb.getChild(0);
    ParseTree migratedPdbP1 = migratedPdb.getChild(0);
  ...
  void testMatchPositionsPara() {
    ...
    ParserRuleContext migratedP = (ParserRuleContext) migrated.getChild(0).getChild(1).getChild(3).getChild(0)
            ...
            .getChild(0) // paragraph name
            ;
    assertEquals(antlrP.getStart().getCharPositionInLine(), migratedP.getStart().getCharPositionInLine());
    assertEquals(antlrP.getStop().getCharPositionInLine(), migratedP.getStop().getCharPositionInLine());
  }
  ...
  void testMatchPositions3() {
    ...
    compareStartStopPositions(antlrS, migratedS);
    ...
    ParserRuleContext migratedP = (ParserRuleContext) migrated.getChild(0).getChild(1).getChild(3)
            .getChild(0) // paragraphs
            .getChild(0);
    compareStartStopPositions(antlrP, migratedP);
  ...
  void testMatchSourceUnit() {
    ...
    org.eclipse.lsp.cobol.core.CobolParser.CompilationUnitContext antlr =
            (org.eclipse.lsp.cobol.core.CobolParser.CompilationUnitContext) antlrParse(source).getChild(0);
    ParseTree antlr1 = antlr.getChild(0) // PU
            .getChild(1) // DC
            .getChild(3) // Pdb
            .getChild(0); // PС
    ParseTree migrated1 = migrated.getChild(0) // PU
            .getChild(1) // DC
            .getChild(3) // Pdb
            .getChild(0); // PС
    compareStartStopPositions(antlr1, migrated1);
  }

  void compareStartStopPositions(ParseTree antlr, ParseTree migrated) {
    ParserRuleContext a = (ParserRuleContext) antlr;
    ParserRuleContext m = (ParserRuleContext) migrated;
    assertEquals(a.getStart().getStartIndex(), m.getStart().getStartIndex(), "Start: StartIndex");
    assertEquals(a.getStart().getLine(), m.getStart().getLine(), "Start: Line");
    assertEquals(a.getStart().getCharPositionInLine(), m.getStart().getCharPositionInLine(), "Start: CharPositionInLine");
    assertEquals(a.getStop().getStartIndex(), m.getStop().getStartIndex(), "Stop: StartIndex");
    assertEquals(a.getStop().getLine(), m.getStop().getLine(), "Stop: Line");
    assertEquals(a.getStop().getCharPositionInLine(), m.getStop().getCharPositionInLine(), "Stop: CharPositionInLine");
  }
}

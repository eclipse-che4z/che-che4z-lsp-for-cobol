...
import static org.eclipse.lsp.cobol.core.migration.Utils.*;
...
class SectionCompositionTest {
  ...
  void test() {
    ...
    compareStartStopPositions(antlrPdb.getChild(0), migratedPdb.getChild(0));
    compareStartStopPositions(antlrPdb.getChild(1), migratedPdb.getChild(1));
    compareStartStopPositions(antlrPdb.getChild(2), migratedPdb.getChild(2));
  }
  ...
  void testParagraphSection2() {
    ...
    ParseTree migratedPd = migrated.getChild(0).getChild(0).getChild(1);
    assertEquals(antlrPd.getChildCount(), migratedPd.getChildCount());
    compareStartStopPositions(antlrPd, migratedPd);

    ParseTree antlrPdb = antlrPd.getChild(3);
    ParseTree migratedPdb = migratedPd.getChild(3);
    compareStartStopPositions(antlrPdb, migratedPdb);
    ...
    compareStartStopPositions(antlrSP, migratedSP);
  ...
  void testParagraphMatchPositions() {
    ...
    org.eclipse.lsp.cobol.core.CobolParser.CompilationUnitContext antlr =
            (org.eclipse.lsp.cobol.core.CobolParser.CompilationUnitContext) antlrParse(source).getChild(0);
    compareAll(antlr.getChild(0).getChild(1), migrated.getChild(0).getChild(1));
  }

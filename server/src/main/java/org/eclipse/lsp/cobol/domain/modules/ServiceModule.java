...
import org.eclipse.lsp.cobol.core.annotation.HandleShutdownState;
...
import static org.aspectj.lang.Aspects14.aspectOf;
...
public class ServiceModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bindCompletions();
    bindCodeActions();
    requestInjection(aspectOf(HandleShutdownState.class));  }

...
startRule
   : .*? ((compilerOptions | copyStatement | includeStatement | replaceAreaStart | replaceOffStatement )+ .*?)* EOF
   ;
...
cobolWord
   : COPYBOOK_IDENTIFIER | IDENTIFIER | charDataKeyword
   ;
...
charDataKeyword
   ...
   | DATA | DATEPROC | DBCS | DD | DEBUG | DECK | DIAGTRUNC | DISPLAY | DLI | DLL | DP | DTR | DU | DUMP | DYN | DYNAM
   | EDF | EJPD | EN | END | ENGLISH | EPILOG | EXCI | EXIT | EXP | EXPORTALL | EXTEND
   ...
   | MAP | MARGINS | MAX | MD | MDECK | MIG | MIXED | MOVE

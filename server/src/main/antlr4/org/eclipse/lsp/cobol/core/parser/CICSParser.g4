...
cobolWord
   ...
   | EBCDIC | EDIT | ENQUEUE | ENTER | ERASE | ESCAPE | EVENT | EXCLUSIVE | EXIT | EXITS | EXTENDED | FIND | FINISH
   | FIRST | FUNCTION_POINTER | GET
   | ID | IDMS | IGNORED | IMPLICIT | INTEGER | INTERNAL | INTERVAL | INVOKED | IN
   | KEEP | KEPT | KEYBOARD
   | LANGUAGE | LAST | LIBRARY | LIST | LOADLIB | LOCAL | LONG_DATE | LONG_TIME | LONGTERM |LOWER | LR | LTERM | MAP
   | MAPS | MMDDYYYY | MAX | MEMBERS | MESSAGE | MODIFIED | MODIFY

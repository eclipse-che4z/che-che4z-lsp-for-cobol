...
cobolWord
   ...
   | KEPT | KEYBOARD
   | LANGUAGE | LIBRARY | LIST | LOCAL | LONG_DATE | LONG_TIME | LOWER | LR | LTERM | MAPS
   | MMDDYYYY | MAX
   ...
   | PASSWORD | PORT | PRINTER | PRIOR | PRIORITY | PROCESS | PROGRAM | PTERM
   | READER | REAL | RECEIVED | RECURSIVE | REF | REMOTE | REMOVE
   | SAVE | SCHEMA | SCRATCH | SCREENSIZE | SESSION | SHARED | SHORT_DATE | SQL | STATISTICS | STATS | STORAGE | SYMBOL | SYSVERSION | SYSTEM

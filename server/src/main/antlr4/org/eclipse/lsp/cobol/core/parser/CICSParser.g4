...
cobolWord
   ...
   | ABEND | ABORT | ALWAYS | AS | ASCII | ASSOCIATED_DATA | ASSOCIATED_DATA_LENGTH | ATTACH
   | BINARY | BIND | BIT | BLOB | BOUNDS
   | CALC | CANCEL | CAPABLE | CCSVERSION | CHANGE | CHANGED | CHANNEL | CHECK | CLOB | CLOSE_DISPOSITION | COBOL
   | CODE | COMMIT | COMMITMENT | CONNECT | CONVENTION | COUNT | CRUNCH | CURRENT | CURSOR
   | DATA | DBCLOB | DBNAME | DBNODE | DB_KEY | DC | DEQUEUE | DEST | DICTNAME | DICTNODE | DISCONNECT
   | DEFAULT | DEFAULT_DISPLAY | DEFINITION | DFHRESP | DFHVALUE | DISK | DOUBLE | DUMP | DUPLICATE
   | EBCDIC | EDIT | ENQUEUE | ENTER | ERASE | ESCAPE | EVENT | EXCLUSIVE | EXIT | EXITS | EXTENDED
   | FIND | FINISH | FIRST | FUNCTION_POINTER | GET
   | ID | IDMS | IGNORED | IMPLICIT | INTEGER | INTERNAL | INTERVAL | INVOKED | IN
   | KEEP | KEPT | KEYBOARD
   ...
   | NAME | NAMED | NATIONAL | NATIONAL_EDITED | NETWORK | NEXT
   | NODEADLOCK | NODENAME | NODUMP | NOLOCK | NORMAL | NOTIFICATION | NOTIFY | NOWAIT | NOWRITE | NUMERIC_DATE
   | NUMERIC_TIME
   | OBTAIN | ODT | OFF | ONLY | ORDERLY | OWN | OWNER | OF | OBJECT | PAGE_INFO | PERMANENT | POINTER_32
   | PASSWORD | PORT | POST | PRINTER | PRIOR | PRIORITY | PROCEDURE | PROCESS | PROGRAM | PROTECTED | PTERM
   | READER | READY | REAL | RECEIVED | RECURSIVE | REF | REMOTE | REMOVE | RETENTION | RETRIEVAL | ROLLBACK | RUN_UNIT
   ...
   | UPDATE | UPGRADE | USAGE_MODE | USER | UTF_8
   | VERSION | VIRTUAL
   | WAIT | WITHIN

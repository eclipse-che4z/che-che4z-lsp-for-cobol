...
cobolWord
   ...
   | SAVE | SCHEMA | SCREENSIZE | SHARED | SHORT_DATE | SQL | STATISTICS | SYMBOL | SYSVERSION | SYSTEM
   | TASK | THREAD | THREAD_LOCAL | TIMER | TODAYS_DATE | TODAYS_NAME | TO | TRANSACTION | TRUNCATED | TYPEDEF
   | USER
   | VERSION | VIRTUAL
   | WAIT | WRITE

...
cobolWord
   ...
   | CAPABLE | CCSVERSION | CHANGED | CHANNEL | CLOB | CLOSE_DISPOSITION | COBOL | COMMITMENT | CONVENTION | COUNT | CRUNCH | CURSOR
   | DBCLOB | DEFAULT | DEFAULT_DISPLAY | DEFINITION | DFHRESP | DFHVALUE | DISK
   ...
   | READER | RECEIVED | RECURSIVE | REF | REMOTE | REMOVE

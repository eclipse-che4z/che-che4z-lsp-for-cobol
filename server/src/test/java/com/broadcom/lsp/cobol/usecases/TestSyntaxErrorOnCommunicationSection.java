  ...
  void test() {
    UseCaseEngine.runTest(
        ...
        Map.of(
            ...
            new Diagnostic(
                null,
                "Syntax error on 'COMMUNICATION' expected {<EOF>, DATA_BASE, END, FILE, ID, IDENTIFICATION, "
                    + "LINKAGE, LOCAL_STORAGE, PROCEDURE, PROGRAM_LIBRARY, REPORT, SCREEN, WORKING_STORAGE}",

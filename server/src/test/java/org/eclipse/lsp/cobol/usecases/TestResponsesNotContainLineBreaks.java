        ...
        ImmutableMap.of(
            ...
            new Diagnostic(
                ...
                "Extraneous input '>' expected {ALL, DATE, DAY, DAY-OF-WEEK, DEBUG-CONTENTS, DEBUG-ITEM, "
                    ...
                    + "FUNCTION, HIGH-VALUE, HIGH-VALUES, LENGTH, LINAGE-COUNTER, LINE-COUNTER, LOW-VALUE, "
                    + "LOW-VALUES, NOT, NULL, NULLS, PAGE-COUNTER, QUOTES, RETURN-CODE, SHIFT-IN, SHIFT-OUT, "
                    + "SORT-CONTROL, SORT-CORE-SIZE, SORT-FILE-SIZE, SORT-MESSAGE, SORT-MODE-SIZE, SORT-RETURN, "
                    + "SPACE, SPACES, TALLY, TIME, TRUE, WHEN-COMPILED, ZERO, ZEROES, ZEROS, '(', '-', '+', "
                    + "'01-49', '66', '77', '88', INTEGERLITERAL, NUMERICLITERAL, NONNUMERICLITERAL, IDENTIFIER, "
                    + "FINALCHARSTRING}",

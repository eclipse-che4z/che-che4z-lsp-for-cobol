...
/** Tests the DAF ROW RESTORE statement */
class TestDAFTableRowRestoreStatement {
  ...
  private static final String TEXT =
      "        IDENTIFICATION DIVISION. \r\n"
          ...
          // Negative tests
          + "            ROW RESTORE {$DSAPRO-XL1|1} {.|3} \r\n"
          + "            ROW RESTORE {GBR4|1|2} {.|3} \r\n"
          + "            ROW RESTORE {$TBLPRO-XL1} FROM {.|4} \r\n"
          + "            ROW RESTORE {$TBLPRO-XL1} FROM {GBR4|2}. \r\n";
  ...
  void test() {
    ...
    UseCaseEngine.runTest(
        ...
        ImmutableMap.of(
            ...
            new Diagnostic(
                null,
                "Syntax error on '.' expected {FROM, IN, OF, '('}",
                DiagnosticSeverity.Error,
                SourceInfoLevels.ERROR.getText()),
            "4",
            new Diagnostic(

...
class CopybookAnalysisTest {
  ...
  private final DataBusBroker dataBus = mock(DataBusBroker.class);
  private final CopybookService copybookService = new CopybookServiceImpl(dataBus, settingsService, files, preprocessor, new CopybookCache(3, 3, "HOURS"));
  private final ReplacingService replacingService = mock(ReplacingService.class);
  ...
  void testServiceResolvesImplicitCopybook() {
    ...
    CopybookAnalysis analysis = createCopybookAnalysis();
  ...
  private CopybookAnalysis createCopybookAnalysis() {
    return new CopybookAnalysis(preprocessor,
        copybookService,
        messageService,
        replacingService);
  }

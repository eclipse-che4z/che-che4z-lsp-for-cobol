...
class PredefinedCopybookAnalysisTest {
  ...
  void testServiceResolvesImplicitCopybook() {
    ...
    PredefinedCopybookAnalysis analysis = createCopybookAnalysis(copybookName.getQualifiedName());
  ...
  void testPredefinedCopybooksLoaded() throws IOException {
    ...
    PredefinedCopybookAnalysis analysis = createCopybookAnalysis(copybookName);
  ...
  private PredefinedCopybookAnalysis createCopybookAnalysis(String copybookName) {

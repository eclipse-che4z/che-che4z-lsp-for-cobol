...
/** Tests the DAF ROW Sort statement */
class TestDAFTableRowSortStatement {
  ...
  private static final String TEXT =
      "        IDENTIFICATION DIVISION. \r\n"
          ...
          // Negative tests
          + "            ROW SORT {$DSAPRO-XL1|1} ASC ON {$DSAPRO-XL1}. \r\n"
          + "            ROW SORT {GBR4|1|2} ASC ON {$DSAPRO-XL1}. \r\n"
          + "            ROW SORT {$TBFPRO-XL1} {.|3} \r\n"
          + "            ROW SORT {$TBFPRO-XL1} ASC ON {GBR4|2}. \r\n";

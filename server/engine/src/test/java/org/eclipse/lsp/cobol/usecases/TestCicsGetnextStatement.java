...
public class TestCicsGetnextStatement {
  ...
  private static final String GETNEXT_EVENT_VALID =
      "GETNEXT EVENT({$varOne}) BROWSETOKEN({$varOne}) COMPOSITE({$varOne}) EVENTTYPE({$varOne}) FIRESTATUS({$varOne}) PREDICATE({$varOne}) TIMER({$varOne})";
  ...
  private static final String GETNEXT_TIMER_VALID =
      "GETNEXT TIMER({$varOne}) BROWSETOKEN({$varOne}) ACTIVITYID({$varOne}) EVENT({$varOne}) STATUS({$varOne}) ABSTIME({$varOne})";
  ...
  private static final String GETNEXT_EVENT_MISSING_INVALID =
      "GETNEXT {_BROWSETOKEN({$varOne}) COMPOSITE({$varOne}) EVENTTYPE({$varOne}) FIRESTATUS({$varOne}) PREDICATE({$varOne}) TIMER({$varOne} )|errorOne_}";

...
public class TestFunction {
  ...
  // positive
  public static final String POSITIVE_ALL_INTRINSIC_INCLUDES_INTRINSIC_FUNC =
      "       IDENTIFICATION DIVISION.\n"
          + "       PROGRAM-ID. EXAMPLE.\n"
          + "       ENVIRONMENT DIVISION.\n"
          + "       CONFIGURATION SECTION.\n"
  ...
  @Test
  void test_positive_all_intrinsic_includes_intrinsic_func() {
    UseCaseEngine.runTest(
        POSITIVE_ALL_INTRINSIC_INCLUDES_INTRINSIC_FUNC, ImmutableList.of(), ImmutableMap.of());
  }
  ...
  public static final String WHEN_COMPILED_CANT_BE_DECLARED =
      "       IDENTIFICATION DIVISION.\n"
          ...
          + "       CONFIGURATION SECTION.\n"
          + "       repository.\n"
          + "           FUNCTION {WHEN-COMPILED|1} INTRINSIC.\n"
          + "       DATA DIVISION.\n"
          + "       WORKING-STORAGE SECTION.\n"
          + "       01 {$*so-data}.\n"
          + "           05 {$*HEX-OF1} pic 9.\n"

  ...
  void test() {
    UseCaseEngine.runTest(
        ...
        ImmutableMap.of(
            ...
            new Diagnostic(
                new Range(),
                "Syntax error on 'EXEC' expected {CBLCARD, COBOL2, COBOL3, CPSM, DLI, EDF, EXCI, FEPI, NATLANG, "
                    ...
                    + "PROCEDURE-POINTER, REDEFINES, SIGN, SYNC, SYNCHRONIZED, TRAILING, USAGE, UTF-8, VALUE, "
                    + "VALUES, '.', IDENTIFIER}",
                DiagnosticSeverity.Error,
                ErrorSource.PARSING.getText()),
            "3",

        ...
        ImmutableMap.of(
            ...
            new Diagnostic(
                ...
                "Syntax error on 'EXEC' expected {CBLCARD, COBOL2, COBOL3, CPSM, DLI, EDF, EPILOG, EXCI, FEPI, "
                    ...
                    + "COMP-4, COMP-5, CPP, DATEPROC, DISPLAY, DISPLAY-1, DP, DYNAMIC, EXTERNAL, FILLER, "
                    + "FUNCTION-POINTER, GDS, GLOBAL, GRAPHIC, GROUP-USAGE, INDEX, IS, JUST, JUSTIFIED, KA, "
                    + "LEADING, LEASM, LIB, LIN, MARGINS, NODE, NODATEPROC, NODP, NOEPILOG, NOFLAGMIG, NOGRAPHIC, "
                    + "NOLIB, NOOPSEQUENCE, NOOPT, NOOPTIMIZE, NOP, NOPROLOG, NOSTDTRUNC, NSEQ, OCCURS, OP, OPMARGINS,"
                    + " OPSEQUENCE, PACKED-DECIMAL, PIC, PICTURE, POINTER, POINTER-32, PROCEDURE-POINTER, PROLOG, "
                    + "REDEFINES, RES, SIGN, SYNC, SYNCHRONIZED, SZ, TRAILING, TRIG, USAGE, UTF-8, VALUE, VALUES, "
                    + "YEARWINDOW, YW, '.', IDENTIFIER}",
                DiagnosticSeverity.Error,
                ErrorSource.PARSING.getText()),
            "3",
            new Diagnostic(

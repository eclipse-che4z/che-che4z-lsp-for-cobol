...
public class TestCICSReadNextReadPrev {
  ...
  private static final String READNEXT_CONSISTENT_REPEATABLE_INVALID =
      "READNEXT FILE({$varFour}) INTO({$varFive}) RIDFLD({$varFive}) {CONSISTENT|error1} {REPEATABLE|error2}";
  ...
  private static final String READNEXT_DOUBLE_UPDATE_INVALID =
      "READNEXT FILE({$varFour}) INTO({$varFive}) RIDFLD({$varFive}) UPDATE {UPDATE|error1} TOKEN({$varFive})";
  private static final String READPREV_DOUBLE_UPDATE_INVALID =
      "READPREV FILE({$varFour}) INTO({$varFive}) RIDFLD({$varFive}) UPDATE {UPDATE|error1} TOKEN({$varFive})";

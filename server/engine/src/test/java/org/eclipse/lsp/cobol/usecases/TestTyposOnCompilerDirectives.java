...
class TestTyposOnCompilerDirectives {
  ...
  private static final String DATA_ERROR_MESSAGE =
      "Syntax error on 'DDATA' expected {ADATA, ADV, AFP, APOST, AR, ARCH, ARITH, AWO, BLOCK0, BUF, BUFSIZE, CICS, "
          ...
          + "NOLIST, NOMAP, NOMD, NOMDECK, NONAME, NONC, NONUM, NONUMBER, NONUMCHECK, NOOBJ, NOOBJECT, NOOFF, NOOFFSET"
          + ", NOPARMCHECK, NOPC, NORENT, NORULES, NOS, NOSEQ, NOSEQUENCE, NOSERV, NOSERVICE, NOSO, NOSOURCE, NOSQL, "
          + "NOSQLC, NOSQLCCSID, NOSQLIMS, NOSSR, NOSSRANGE, NOSTGOPT, NOSUPP, NOSUPPRESS, NOTERM, NOTERMINAL, NOTEST,"
          + " NOTHREAD, NOVBREF, NOWD, NOWORD, NOX, NOXREF, NOZC, NOZONECHECK, NOZWB, NS, NSYMBOL, NUM, NUMBER, "
          + "NUMCHECK, NUMPROC, OBJ, OBJECT, OFF, OFFSET, OPT, OPTFILE, OPTIMIZE, OUT, OUTDD, PARMCHECK, PC, PGMN, "
          + "PGMNAME, QUA, QUALIFY, QUOTE, Q, RENT, RMODE, RULES, SEQ, SEQUENCE, SERV, SERVICE, SO, SOURCE, SPACE, SQL"
          + ", SQLC, SQLCCSID, SQLIMS, SSR, SSRANGE, STGOPT, SUPP, SUPPRESS, S, TERM, TERMINAL, TEST, THREAD, TRUNC, "
          + "TUNE, VBREF, VLR, VS, VSAMOPENFS, WD, WORD, XMLPARSE, XOPTS, XP, XREF, X, ZC, ZD, ZONECHECK, ZONEDATA, "
          + "ZWB, ', ','}";

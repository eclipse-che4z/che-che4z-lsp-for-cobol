...
public class TestCICSCsdSP {
    ...
    private static Stream<String> getValidOptions() {
        return Stream.of(
                ...
                "CSD DJAR ALTER RESID({$varFour}) GROUP({$varFour}) ATTRIBUTES({$varFour}) ATTRLEN({$varFour}) COMPAT",
                "CSD PROGRAM ALTER RESID({$varFour}) GROUP({$varFour}) NOCOMPAT ATTRIBUTES({$varFour})",
                "CSD TDQUEUE ALTER RESID({$varFour}) ATTRIBUTES({$varFour}) GROUP({$varFour}) COMPATMODE({$varOne})",
                "CSD APPEND LIST({$varFour}) TO({$varFour}) NOHANDLE",
                "CSD NOHANDLE TO({$varFour}) COPY GROUP({$varFour}) DUPERROR ",
                "CSD NOHANDLE ATOMSERVICE AS({$varFour}) RESID({$varFour}) GROUP({$varFour}) COPY DUPNOREPLACE ",
                ...
                "CSD GETNEXTRSRCE RESTYPE({$varOne}) RESID({$varFour}) GROUP({$varFour}) ATTRIBUTES({$varFour}) ATTRLEN({$varFour})",
                ...
                "CSD RENAME LIBRARY GROUP({$varFour}) AS({$varFour})",
                ...
                "CSD COMPAT USERDEFINE RESID({$varFour}) GROUP({$varFour}) ATTRIBUTES({$varFour}) NOHANDLE PIPELINE",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) ATOMSERVICE",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) BUNDLE",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) CONNECTION",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) CORBASERVER",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) DB2CONN",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) DB2ENTRY",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) DB2TRAN",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) DJAR",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) DOCTEMPLATE",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) DUMPCODE",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) ENQMODEL",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) FILE",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) IPCONN",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) JOURNALMODEL",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) JVMSERVER",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) LIBRARY",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) LSRPOOL",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) MAPSET",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) MQCONN",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) MQMONITOR",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) PARTITIONSET",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) PARTNER",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) PIPELINE",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) PROCESSTYPE",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) PROFILE",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) PROGRAM",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) REQUESTMODEL",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) SESSIONS",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) TCPIPSERVICE",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) TDQUEUE",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) TERMINAL",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) TRANCLASS",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) TRANSACTION",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) TSMODEL",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) TYPETERM",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) URIMAP",
                "CSD RENAME GROUP({$varFour}) AS({$varFour}) WEBSERVICE");
    };
    private static final String CSD_CVDA_MISSING = "Missing required option: RESTYPE or ATOMSERVICE or BUNDLE or CONNECTION or CORBASERVER or DB2CONN or DB2ENTRY or DB2TRAN or "
            + "DJAR or DOCTEMPLATE or DUMPCODE or ENQMODEL or FILE or IPCONN or JOURNALMODEL or JVMSERVER or LIBRARY or LSRPOOL or MAPSET or MQCONN or MQMONITOR or PARTITIONSET or "
            + "PARTNER or PIPELINE or PROCESSTYPE or PROFILE or PROGRAM or REQUESTMODEL or SESSIONS or TCPIPSERVICE or TDQUEUE or TERMINAL or TRANCLASS or TRANSACTION or TSMODEL or "
            + "TYPETERM or URIMAP or WEBSERVICE";
    private static final String CSD_ADD_INVALID =
            "CSD {ADD|error|error2}";
    private static final String CDS_ALTER_INVALID =
    ...
    private static final String CDS_COPY_MUTUALEX_INVALID =
            "CSD COPY PARTNER GROUP({$varFour}) RESID({$varFour}) TO({$varFour}) {DUPNOREPLACE|error} {DUPERROR|error2}";
    private static final String CDS_COPY_MUTUALEX_ASTO_INVALID =
            "CSD COPY TSMODEL GROUP({$varFour}) RESID({$varFour}) {TO|error}({$varFour}) {AS|error2}({$varFour})";
    private static final String CDS_DEFINE_INVALID =
            "CSD {DEFINE|error|error2|error3|error4}";
    private static final String CDS_DELETE_INVALID =
            "CSD {DELETE|error}";
    private static final String CDS_DELETE_MUTUALEX_INVALID =
            "CSD DELETE GROUP({$varFour}) {REMOVE|error} {LISTACTION|error2}({$varOne})";
    private static final String CDS_GETNEXTGROUP_INVALID =
            "CSD {GETNEXTGROUP|error}";
    private static final String CDS_GETNEXTLIST_INVALID =
            "CSD {GETNEXTLIST|error}";
    private static final String CDS_GETNEXTRSRCE_INVALID =
            "CSD {GETNEXTRSRCE|error|error2|error3}";
    private static final String CDS_INQUIREGROUP_INVALID =
            "CSD {INQUIREGROUP|error}";
    private static final String CDS_INQUIRELIST_INVALID =
            "CSD {INQUIRELIST|error}";
    ...
    private static final String CDS_INQUIRERSRCE_MUTUALEX_INVALID =
            "CSD INQUIRERSRCE BUNDLE RESID({$varFour}) GROUP({$varFour}) {ATTRIBUTES|error}({$varFour}) {SET|error}({$varFour})";
    private static final String CDS_INSTALL_INVALID =
            "CSD {INSTALL|error}";
    ...
    private static final String CDS_REMOVE_INVALID =
            "CSD {_LIST({$varFour}) REMOVE|error_}";
    private static final String CDS_RENAME_INVALID =
            "CSD {RENAME|error|error2|error3}";
    private static final String CDS_STARTBRRSRCE_INVALID =
            "CSD {STARTBRRSRCE|error}";
    private static final String CDS_UNLOCK_INVALID =
            "CSD {UNLOCK|error}";
    ...
    void testCdsCopySpMutualExInvalid() {
        Map<String, Diagnostic> expectedDiagnostic =
                ImmutableMap.of(
                        ...
                        new Diagnostic(
                                new Range(),
                                "Exactly one option required, options are mutually exclusive: DUPERROR or DUPACTION or DUPNOREPLACE or DUPREPLACE",
                                DiagnosticSeverity.Error,
                                ErrorSource.PARSING.getText()),
                        "error2",
                        new Diagnostic(

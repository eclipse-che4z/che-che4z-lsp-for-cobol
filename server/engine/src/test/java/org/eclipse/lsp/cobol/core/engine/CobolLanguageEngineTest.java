...
class CobolLanguageEngineTest {
  ...
  void testLanguageEngineRun() {
    ...
    SymbolAccumulatorService symbolAccumulatorService = mock(SymbolAccumulatorService.class);
    ...
    CobolLanguageEngine engine =
        new CobolLanguageEngine(
            ...
            dialectService, symbolAccumulatorService, astProcessor, injectService, symbolsRepository);

...
class TestReplacingForSeveralTokensInOneLine {
  ...
  void test() {
    UseCaseEngine.runTest(
        ...
        ImmutableMap.of(
            "invalid", new Diagnostic(new Range(), MESSAGE, DiagnosticSeverity.Error,  ErrorStage.COPYBOOK.getText()),
            "invalidS", new Diagnostic(new Range(), MESSAGE, DiagnosticSeverity.Error,  ErrorStage.SYNTAX.getText())
                ));
  }
}

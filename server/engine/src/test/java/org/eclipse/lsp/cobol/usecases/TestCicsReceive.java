...
public class TestCicsReceive {
    ...
    private static final String[] RECEIVE_VALID_ONE = {
            "RECEIVE"
    };

    private static final String[] RECEIVE_INVALID_ONE = {
            "RECEIVE", "{FLENGTH|errorOne}(1)", "{LENGTH|errorOne}(1)"
    };

    private static final String[] RECEIVE_INVALID_TWO = {
    ...
    private static final String[] RECEIVE_INVALID_FOUR = {
            "RECEIVE", "{_MAP(1)", "MAPPINGDEV(1)", "FROM(1)|errorOne_}"
    };
        ...
        UseCaseEngine.runTest(
                ...
                ImmutableMap.of(
                        ...
                        new Diagnostic(
                                ...
                                ErrorSource.PARSING.getText()), "errorTwo",
                        new Diagnostic(
                                new Range(),
                                "Exactly one option required, options are mutually exclusive: LENGTH or FLENGTH",
                                DiagnosticSeverity.Error,

...
import static org.eclipse.lsp.cobol.service.delegates.completions.MockCompletionModel.*;
...
class CompletionsTest {
  ...
  void testCollecting() {
    Completions completions =
        new Completions(
            ImmutableSet.of(
                new CopybookCompletion(), new VariableCompletion(SYMBOL_STORAGE),
                    new ParagraphCompletion(SYMBOL_STORAGE)));

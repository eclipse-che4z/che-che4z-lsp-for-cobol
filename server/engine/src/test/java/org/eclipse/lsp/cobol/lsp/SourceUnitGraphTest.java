...
class SourceUnitGraphTest {
  public static final Uri URI = new Uri("file:///document.cbl");
  ...
  void testLinksBetweenCopybookAndSourceCode() {
    Uri copy1Uri = new Uri("file:///copy1.cpy");
    Uri copy2Uri = new Uri("file:///copy2.cpy");
    Uri copy3Uri = new Uri("file:///copy3.cpy");
    SourceUnitGraph sourceUnitGraph =
        new SourceUnitGraph(fileService, asyncAnalysisService);
    ...
    CopyNode copyNode1 =
        new CopyNode(
            ...
            new Location(URI.toString(), new Range(new Position(2, 7), new Position(2, 14))),
            "COPY1",
            copy1Uri);
    CopyNode copyNode2 =
        new CopyNode(
            Locality.builder().uri(copy1Uri).build(),
            new Location(copy1Uri.toString(), new Range(new Position(0, 7), new Position(0, 14))),
            "COPY2",
            copy2Uri);
    CopyNode copyNode3 =
        new CopyNode(
            Locality.builder().uri(copy2Uri).build(),
            new Location(copy2Uri.toString(), new Range(new Position(0, 7), new Position(0, 16))),
            "COPY3",
            copy3Uri);
    ...
    List<Uri> allAssociatedFilesForACopybook =

...
public class TestCicsSignonStatement {
  ...
  private static final String SIGNON_VALID_1 =
      "SIGNON USERID({$varOne}) CHANGETIME({$varOne}) DAYSLEFT({$varOne}) ESMREASON({$varOne}) ESMRESP({$varOne}) EXPIRYTIME({$varOne}) GROUPID({$varOne}) INVALIDCOUNT({$varOne}) LANGUAGECODE({$varOne}) LANGINUSE({$varOne}) LASTUSETIME({$varOne}) NATLANGINUSE({$varOne}) PHRASE({$varOne}) PHRASELEN({$varOne}) NEWPHRASE({$varOne}) NEWPHRASELEN({$varOne}) OIDCARD({$varOne})";
  ...
  private static final String SIGNONTOKEN_VALID_2 =
      "SIGNON TOKEN({$varOne}) TOKENLEN({$varOne}) TOKENTYPE({$varOne}) DATATYPE({$varOne}) GROUPID({$varOne}) LANGUAGECODE({$varOne}) LANGINUSE({$varOne}) NATLANGINUSE({$varOne}) ESMREASON({$varOne}) ESMRESP({$varOne})";
  ...
  private static final String SIGNONTOKEN_INVALID_1 =
      "SIGNON TOKEN({$varOne}) TOKENLEN({$varOne}) {TOKENTYPE|errorOne}({$varOne}) {KERBEROS|errorTwo}";

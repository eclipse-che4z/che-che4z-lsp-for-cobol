...
public class TestCICSInquireSP {
  ...
  private static final String TRACETYPE_INVALID =
      "INQUIRE TRACETYPE {SPECIAL|errorOne} {FLAGSET|errorTwo}(1) {AP|errorThree}(1) {APPLICATION|errorFour}(1)";
  ...
  private static final String STATS_INVALID =
      "INQUIRE {_STATISTICS {ENDOFDAY|errorOne}(1) {ENDOFDAYHRS|errorTwo}(1) RECORDING(1)|errorThree|errorFour_}";

  private static final String PROGRAM_INVALID =
      "INQUIRE {_PROGRAM(1) APPLICATION(1) APPLMAJORVER(1) APPLMICROVER(1) APPLMINORVER(1)|errorOne_}";

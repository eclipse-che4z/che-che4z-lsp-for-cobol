...
public class TestCICSTransform {
    private static final String TRANSFORM_DATATOJSON_VALID = "TRANSFORM DATATOJSON CHANNEL({$varOne}) INCONTAINER({$varOne}) OUTCONTAINER({$varOne}) TRANSFORMER({$varOne})";
    private static final String TRANSFORM_JSONTODATA_VALID = "TRANSFORM JSONTODATA CHANNEL({$varOne}) INCONTAINER({$varOne}) OUTCONTAINER({$varOne}) TRANSFORMER({$varOne})";

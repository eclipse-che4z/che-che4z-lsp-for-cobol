...
public class TestCICSTransform {
  private static final String TRANSFORM_DATATOJSON_VALID =
      "TRANSFORM DATATOJSON CHANNEL({$varOne}) INCONTAINER({$varOne}) OUTCONTAINER({$varOne}) TRANSFORMER({$varOne})";
  private static final String TRANSFORM_JSONTODATA_VALID =
      "TRANSFORM JSONTODATA CHANNEL({$varOne}) INCONTAINER({$varOne}) OUTCONTAINER({$varOne}) TRANSFORMER({$varOne})";

  private static final String TRANSFORM_DATATOXML_VALID =
      "TRANSFORM DATATOXML CHANNEL({$varOne}) DATCONTAINER({$varOne}) ELEMNAME({$varOne}) ELEMNAMELEN({$varOne}) ELEMNS({$varOne}) ELEMNSLEN({$varOne}) TYPENAME({$varOne}) TYPENAMELEN({$varOne}) TYPENS({$varOne}) TYPENSLEN({$varOne}) XMLCONTAINER({$varOne}) XMLTRANSFORM({$varOne})";
  private static final String TRANSFORM_XMLTODATA_VALID =
      "TRANSFORM XMLTODATA CHANNEL({$varOne}) DATCONTAINER({$varOne}) ELEMNAME({$varOne}) ELEMNAMELEN({$varOne}) ELEMNS({$varOne}) ELEMNSLEN({$varOne}) NSCONTAINER({$varOne}) TYPENAME({$varOne}) TYPENAMELEN({$varOne}) TYPENS({$varOne}) TYPENSLEN({$varOne}) XMLCONTAINER({$varOne}) XMLTRANSFORM({$varOne})";

  private static final String TRANSFORM_JSONTODATA_INVALID =
      "TRANSFORM {_DATATOJSON INCONTAINER({$varOne}) OUTCONTAINER({$varOne}) TRANSFORMER({$varOne} )|errorOne_}";
  private static final String TRANSFORM_DATATOJSON_INVALID =
      "TRANSFORM {_JSONTODATA CHANNEL({$varOne}) OUTCONTAINER({$varOne}) TRANSFORMER({$varOne} )|errorOne_}";

  private static final String TRANSFORM_DATATOXML_INVALID =
      "TRANSFORM DATATOXML CHANNEL({$varOne}) DATCONTAINER({$varOne}) {NSCONTAINER|errorOne}({$varOne}) XMLCONTAINER({$varOne}) XMLTRANSFORM({$varOne})";
  private static final String TRANSFORM_XMLTODATA_INVALID =
      "TRANSFORM {_XMLTODATA DATCONTAINER({$varOne}) ELEMNAME({$varOne}) ELEMNAMELEN({$varOne}) ELEMNS({$varOne}) ELEMNSLEN({$varOne}) NSCONTAINER({$varOne}) TYPENAME({$varOne}) TYPENAMELEN({$varOne}) TYPENS({$varOne}) TYPENSLEN({$varOne}) XMLCONTAINER({$varOne}) XMLTRANSFORM({$varOne} )|errorOne_}";

  private static final String TRANSFORM_BOTH_JSON_INVALID =
      "TRANSFORM {DATATOJSON|errorOne} {JSONTODATA|errorTwo} CHANNEL({$varOne}) INCONTAINER({$varOne}) OUTCONTAINER({$varOne}) TRANSFORMER({$varOne})";
  private static final String TRANSFORM_BOTH_XML_INVALID =
      "TRANSFORM {DATATOXML|errorOne} {XMLTODATA|errorTwo} CHANNEL({$varOne}) DATCONTAINER({$varOne}) ELEMNAME({$varOne}) ELEMNAMELEN({$varOne}) ELEMNS({$varOne}) ELEMNSLEN({$varOne}) TYPENAME({$varOne}) TYPENAMELEN({$varOne}) TYPENS({$varOne}) TYPENSLEN({$varOne}) XMLCONTAINER({$varOne}) XMLTRANSFORM({$varOne})";

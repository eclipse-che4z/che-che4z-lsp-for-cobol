...
JAVA_SHAREABLE_OFF   :J A V A MINUSCHAR S H A R E A B L E [ \t\f]+ O F F;
JAVA_SHAREABLE_ON    :J A V A MINUSCHAR S H A R E A B L E [ \t\f]+ O N;
JP: J P;
...
NONNUMERICLITERAL: N O N N U M E R I C L I T E R A L;
NONUM: N O N U M;

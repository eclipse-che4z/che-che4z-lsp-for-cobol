...
cics_inquire_atomservice: ATOMSERVICE cics_data_value? ((START | END | NEXT) | (ATOMTYPE | CHANGEAGENT | ENABLESTATUS | INSTALLAGENT | RESOURCETYPE) cics_cvda | (BINDFILE | CHANGEAGREL | CHANGETIME | CHANGEUSRID | CONFIGFILE | DEFINESOURCE | DEFINETIME | INSTALLTIME | INSTALLUSRID | RESOURCENAME | URIMAP | XMLTRANSFORM) cics_data_area | cics_handle_response)*;
cics_inquire_autinstmodel: AUTINSTMODEL cics_data_value? ((START | END | NEXT) | cics_handle_response)*;
...
cics_inquire_brfacility: BRFACILITY cics_data_value? ((START | END | NEXT) | (KEEPTIME | LINKSYSTEM | LINKSYSNET | NETNAME | REMOTESYSNET | REMOTESYSTEM | TASKID | TERMID | TRANSACTION) cics_data_area | (NAMESPACE | TERMSTATUS) cics_cvda | cics_handle_response)*;
...
cics_inquire_connection: CONNECTION cics_data_value? ((START | END | NEXT) | (ACCESSMETHOD | ACQSTATUS | AUTOCONNECT | CHANGEAGENT | CONNSTATUS | CONNTYPE | CQP | EXITTRACING | INSTALLAGENT | PENDSTATUS | PROTOCOL | RECOVSTATUS | SERVSTATUS | XLNSTATUS | ZCPTRACING) cics_cvda | (AIDCOUNT | CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | GRNAME | INSTALLTIME | INSTALLUSRID | LINKSYSTEM | MEMBERNAME | NETNAME | NQNAME | RECEIVECOUNT | REMOTENAME | REMOTESYSNET | REMOTESYSTEM | SENDCOUNT) cics_data_area | cics_handle_response)*;
cics_inquire_cfdtpool: CFDTPOOL cics_data_value? ((START | END | NEXT) | CONNSTATUS cics_cvda | cics_handle_response)*;
...
cics_inquire_doctemplate: DOCTEMPLATE cics_data_value? ((START | END | NEXT) | (APPENDCRLF | CHANGEAGENT | INSTALLAGENT | TEMPLATETYPE | TYPE) cics_cvda | (CACHESIZE | CHANGEAGREL | CHANGETIME | CHANGEUSRID | DDNAME | DEFINESOURCE | DEFINETIME | DSNAME | EXITPGM | FILE | HFSFILE | INSTALLTIME | INSTALLUSRID | MEMBER | PROGRAM | TDQUEUE | TEMPLATENAME | TSQUEUE) cics_data_area | cics_handle_response)*;
cics_inquire_dsname: DSNAME cics_data_value? ((START | END | NEXT) | (ACCESSMETHOD | AVAILABILITY | BACKUPTYPE | OBJECT | LOGREPSTATUS | LOSTLOCKS | QUIESCESTATE | RECOVSTATUS | RETLOCKS | VALIDITY) cics_cvda | (BASEDSNAME | FILECOUNT | FWDRECOVLOG | FWDRECOVLSN) cics_data_area | cics_handle_response)*;
...
cics_inquire_enqmodel: ENQMODEL cics_data_value? ((START | END | NEXT) | (CHANGEAGENT | INSTALLAGENT | STATUS) cics_cvda | (CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | ENQSCOPE | ENQNAME | INSTALLTIME | INSTALLUSRID) cics_data_area | cics_handle_response)*;
cics_inquire_epadapter: EPADAPTER cics_data_value? ((START | END | NEXT) | (ADAPTERTYPE | AUTHORITY | DATAFORMAT | EMITMODE | ENABLESTATUS | INVOKETYPE | PRIORITY | TRANSMODE | CHANGEAGENT | INSTALLAGENT) cics_cvda | (AUTHUSERID | CONFIGDATA1 | PROGRAM | TRANSACTION | CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | INSTALLTIME | INSTALLUSRID) cics_data_area | cics_handle_response)*;
cics_inquire_epadapterset: EPADAPTERSET cics_data_area? ((START | END | NEXT) | (EPADAPTERNUM |  CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | INSTALLTIME | INSTALLUSRID) cics_data_area | (ENABLESTATUS | CHANGEAGENT | INSTALLAGENT) cics_cvda | cics_handle_response)*;
...
cics_inquire_eventbinding: EVENTBINDING cics_data_value? ((START | END | NEXT) | (CHANGEAGENT | ENABLESTATUS | EPADAPTERRES | INSTALLAGENT) cics_cvda | (CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | EPADAPTER | EPADAPTERSET | INSTALLTIME | INSTALLUSRID | USERTAG) cics_data_area | cics_handle_response)*;
...
cics_inquire_journalmodel: JOURNALMODEL cics_data_value? ((START | END | NEXT) | (CHANGEAGENT | INSTALLAGENT | TYPE) cics_cvda | (CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | INSTALLTIME | INSTALLUSRID | JOURNALNAME | STREAMNAME) cics_data_area | cics_handle_response)*;
cics_inquire_journalname: JOURNALNAME cics_data_value? ((START | END | NEXT) | (STATUS | TYPE) cics_cvda | STREAMNAME cics_data_area | cics_handle_response)*;
...
cics_inquire_mqmonitor: MQMONITOR cics_data_value? ((START | END | NEXT) | (CHANGEAGENT | ENABLESTATUS | INSTALLAGENT | MONSTATUS) cics_cvda | (CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | INSTALLTIME | INSTALLUSRID | MONDATA | MONUSERID | QNAME | TASKID | TRANSACTION | USERID) cics_data_area | cics_handle_response)*;
cics_inquire_mvstcb: MVSTCB cics_ref? ((START | END | NEXT) | SET cics_ref | NUMELEMENTS cics_data_area | cics_handle_response)*;
cics_inquire_nodejsapp: NODEJSAPP cics_data_value? ((START | END | NEXT) | (TERMINAL | BUNDLE | CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | INSTALLTIME | INSTALLUSRID | LERUNOPTS | LOG | NODEHOME | PID | PROFILE | STARTSCRIPT | STDERR | STDOUT | TRACE) cics_data_area | (CHANGEAGENT | ENABLESTATUS | INSTALLAGENT) cics_cvda | cics_handle_response)*;
...
cics_inquire_partner: PARTNER cics_data_value? ((START | END | NEXT) | (NETWORK | NETNAME | PROFILE | TPNAME | TPNAMELEN) cics_data_area | cics_handle_response)*;
cics_inquire_pipeline: PIPELINE cics_data_value? ((START | END | NEXT) | (CHANGEAGENT | ENABLESTATUS | INSTALLAGENT | MODE | MTOMNOXOPST | MTOMST | SENDMTOMST | XOPDIRECTST | XOPSUPPORTST) cics_cvda | (CHANGEAGREL | CHANGETIME | CHANGEUSRID | CIDDOMAIN | CONFIGFILE | DEFINESOURCE | DEFINETIME | INSTALLTIME | INSTALLUSRID | MSGFORMAT | RESPWAIT | SHELF | SOAPLEVEL | SOAPRNUM | SOAPVNUM | WSDIR) cics_data_area | cics_handle_response)*;
cics_inquire_policy: POLICY cics_data_value? ((START | END | NEXT) | (BUNDLE | CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | INSTALLTIME | INSTALLUSRID | USERTAG) cics_data_area | (CHANGEAGENT | ENABLESTATUS | INSTALLAGENT) cics_cvda | cics_handle_response)*;
...
cics_inquire_processtype: PROCESSTYPE cics_data_value? ((START | END | NEXT) | (AUDITLOG | CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | FILE | INSTALLTIME | INSTALLUSRID) cics_data_area | (AUDITLEVEL | CHANGEAGENT | INSTALLAGENT | STATUS) cics_cvda | cics_handle_response)*;
cics_inquire_profile: PROFILE cics_data_value? ((START | END | NEXT) | (CHANGEAGENT | INSTALLAGENT) cics_cvda | (CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | INSTALLTIME | INSTALLUSRID) cics_data_area | cics_handle_response)*;
...
cics_inquire_secrecording: SECRECORDING cics_data_value? ((START | END | NEXT) | (ODADPTRID | ODADPTRDATA1 | ODADPTRDATA2 | ODADPTRDATA3 | ODAPPLID | ODCLNTIPADDR | ODCLNTPORT | ODFACILNAME | ODFACILTYPE | ODIPFAMILY | ODLUNAME | ODNETID | ODNETWORKID | ODSERVERPORT | ODTCPIPS | ODTRANSID | ODUSERID) cics_data_value | (MAXIMUM | CURRENT) cics_data_area | cics_handle_response)*;
...
cics_inquire_streamname: STREAMNAME cics_data_value? ((START | END | NEXT) | (STATUS | SYSTEMLOG) cics_cvda | USECOUNT cics_data_area | cics_handle_response)*;
cics_inquire_subpool: SUBPOOL cics_data_area (DSANAME cics_data_area | cics_handle_response)*;
cics_inquire_sysdumpcode: SYSDUMPCODE cics_data_value? ((START | END | NEXT) | (CHANGEAGENT | DAEOPTION | DUMPSCOPE | INSTALLAGENT | SHUTOPTION | SYSDUMPING) cics_cvda | (CHANGEAGREL | CHANGETIME | CHANGEUSRID | CURRENT | DEFINESOURCE | DEFINETIME | DSPLIST | INSTALLTIME | INSTALLUSRID | JOBLIST | MAXIMUM) cics_data_area | cics_handle_response)*;
...
cics_inquire_trandumpcode: TRANDUMPCODE cics_data_value? ((START | END | NEXT) | (CURRENT | MAXIMUM | CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | INSTALLTIME | INSTALLUSRID) cics_data_area | (DUMPSCOPE | SHUTOPTION | SYSDUMPING | TRANDUMPING | CHANGEAGENT | INSTALLAGENT) cics_cvda |  cics_handle_response)*;
cics_inquire_transaction: TRANSACTION  cics_data_value? (AT cics_data_value | (START | END | NEXT) | (BREXIT | DTIMEOUT | FACILITYLIKE | INDOUBTMINS | OTSTIMEOUT | PRIORITY | PROFILE | PROGRAM | REMOTENAME | REMOTESYSTEM | RTIMEOUT | RUNAWAY | TCLASS | TRANCLASS | TRPROF | TWASIZE | CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | INSTALLTIME | INSTALLUSRID) cics_data_area | (APPLICATION | APPLMAJORVER | APPLMICROVER | APPLMINORVER | OPERATION | PLATFORM) cics_data_value | (AVAILSTATUS | CMDSEC | DUMPING | INDOUBT | INDOUBTWAIT | ISOLATEST | PURGEABILITY | RESSEC | ROUTING | ROUTESTATUS | RUNAWAYTYPE | SCRNSIZE | SHUTDOWN | STATUS | STORAGECLEAR | TASKDATAKEY | TASKDATALOC | TRACING | CHANGEAGENT | INSTALLAGENT) cics_cvda |  cics_handle_response)*;
cics_inquire_tsmodel: TSMODEL cics_data_value? ((START | END | NEXT) | (CHANGEAGREL | CHANGETIME | CHANGEUSRID | DEFINESOURCE | DEFINETIME | EXPIRYINT | EXPIRYINTMIN | INSTALLTIME | INSTALLUSRID | POOLNAME | PREFIX | REMOTEPREFIX | REMOTESYSTEM) cics_data_area | (CHANGEAGENT | INSTALLAGENT | LOCATION | RECOVSTATUS | SECURITYST) cics_cvda |  cics_handle_response)*;
cics_inquire_tspool: TSPOOL cics_data_value? ((START | END | NEXT) | CONNSTATUS cics_cvda |  cics_handle_response)*;
...
cics_inquire_uow: UOW cics_data_area? ((START | END | NEXT) | (AGE | LINK | NETNAME | NETUOWID | OTSTID | SYSID | TASKID | TERMID | TRANSID | USERID) cics_data_area | (UOWSTATE | WAITCAUSE | WAITSTATE) cics_cvda |  cics_handle_response)*;
...
cicsLexerDefinedVariableUsageTokens: ABCODE | ABDUMP | ABEND | ABORT | ABPROGRAM | ABOFFSET | ABSTIME | ACCUM | ACEE | ACQACTIVITY
    ...
    | ERASEAUP | ERRTERM | ESMREASON | ESMRESP | EVENT | EVENTTYPE | EVENTUAL | EWASUPP | | EXACTMATCH EXPECT | EXPIRYTIME | EXTDS

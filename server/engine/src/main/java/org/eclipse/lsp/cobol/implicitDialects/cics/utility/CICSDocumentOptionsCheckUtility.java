...
public class CICSDocumentOptionsCheckUtility extends CICSOptionsCheckBaseUtility {
    ...
    public CICSDocumentOptionsCheckUtility(DialectProcessingContext context, List<SyntaxError> errors) {
    ...
    private void checkDocumentCreate(CICSParser.Cics_document_createContext ctx) {
        ...
        checkAllOptionsArePresentOrAbsent("SYMBOLLIST, LISTLENGTH", ctx, ctx.SYMBOLLIST(), ctx.LISTLENGTH());
    }

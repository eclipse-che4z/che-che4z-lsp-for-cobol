...
public class SnippetCompletion implements Completion {
  ...
  private static final String LANGUAG_ID = "COBOL";
  ...
  private CompletionItem toSnippetCompletions(SnippetsModel snippet) {
    ...
    item.setLabelDetails(getMoreLabelDetails(snippet.getKey(), snippet.getDescription()));
  ...
  private CompletionItemLabelDetails getMoreLabelDetails(String key, String description) {

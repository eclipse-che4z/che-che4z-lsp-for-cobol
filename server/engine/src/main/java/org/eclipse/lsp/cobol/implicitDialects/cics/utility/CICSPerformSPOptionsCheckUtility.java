...
public class CICSPerformSPOptionsCheckUtility extends CICSOptionsCheckBaseUtility {
    ...
    private void checkstatistics(CICSParser.Cics_perform_statisticsContext ctx) {
        ...
        if (!ctx.ALL().isEmpty() || !ctx.RESETNOW().isEmpty()){
            ...
            checkHasIllegalOptions(ctx.BUNDLE(), "BUNDLE");
            checkHasIllegalOptions(ctx.CAPTURESPEC(), "CAPTURESPEC");
            checkHasIllegalOptions(ctx.CIPHER(), "CIPHER");
            checkHasIllegalOptions(ctx.CONNECTION(), "CONNECTION");
            checkHasIllegalOptions(ctx.DB2(), "DB2");
            checkHasIllegalOptions(ctx.DISPATCHER(), "DISPATCHER");
            checkHasIllegalOptions(ctx.DOCTEMPLATE(), "DOCTEMPLATE");
            checkHasIllegalOptions(ctx.ENQUEUE(), "ENQUEUE");
            checkHasIllegalOptions(ctx.EPADAPTER(), "EPADAPTER");
            checkHasIllegalOptions(ctx.EVENTBINDING(), "EVENTBINDING");
            checkHasIllegalOptions(ctx.EVENTPROCESS(), "EVENTPROCESS");
            checkHasIllegalOptions(ctx.FEPI(), "FEPI");
            checkHasIllegalOptions(ctx.FILE(), "FILE");
            checkHasIllegalOptions(ctx.IPCONN(), "IPCONN");
            checkHasIllegalOptions(ctx.JOURNALNAME(), "JOURNALNAME");
            checkHasIllegalOptions(ctx.JOURNALNUM(), "JOURNALNUM");
            checkHasIllegalOptions(ctx.JVMPROGRAM(), "JVMPROGRAM");
            checkHasIllegalOptions(ctx.JVMSERVER(), "JVMSERVER");
            checkHasIllegalOptions(ctx.LIBRARY(), "LIBRARY");
            checkHasIllegalOptions(ctx.LSRPOOL(), "LSRPOOL");
            ...
            checkHasIllegalOptions(ctx.PROGRAM(), "PROGRAM");
            checkHasIllegalOptions(ctx.PROGRAMDEF(), "PROGRAMDEF");
            checkHasIllegalOptions(ctx.RECOVERY(), "RECOVERY");
            checkHasIllegalOptions(ctx.SECURITY(), "SECURITY");
            checkHasIllegalOptions(ctx.STATS(), "STATS");
            checkHasIllegalOptions(ctx.STORAGE(), "STORAGE");
            checkHasIllegalOptions(ctx.STREAMNAME(), "STREAMNAME");
            checkHasIllegalOptions(ctx.SYSDUMP(), "SYSDUMP");
            checkHasIllegalOptions(ctx.TABLEMGR(), "TABLEMGR");
            checkHasIllegalOptions(ctx.TCPIP(), "TCPIP");
            checkHasIllegalOptions(ctx.TCPIPSERVICE(), "TCPIPSERVICE");
            checkHasIllegalOptions(ctx.TDQUEUE(), "TDQUEUE");
            checkHasIllegalOptions(ctx.TERMINAL(), "TERMINAL");
            checkHasIllegalOptions(ctx.TRANCLASS(), "TRANCLASS");
            checkHasIllegalOptions(ctx.TCLASS(), "TCLASS");
            checkHasIllegalOptions(ctx.TRANDUMP(), "TRANDUMP");
            checkHasIllegalOptions(ctx.TRANSACTION(), "TRANSACTION");
            checkHasIllegalOptions(ctx.TSQUEUE(), "TSQUEUE");
            checkHasIllegalOptions(ctx.URIMAP(), "URIMAP");
            checkHasIllegalOptions(ctx.USER(), "USER");
            checkHasIllegalOptions(ctx.VTAM(), "VTAM");
            checkHasIllegalOptions(ctx.WEBSERVICE(), "WEBSERVICE");
            checkHasIllegalOptions(ctx.XMLTRANSFORM(), "XMLTRANSFORM");
        }
    }

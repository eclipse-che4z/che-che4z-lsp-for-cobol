            ...
            new HashMap<Integer, ErrorSeverity>() {
                {
                    ...
                    put(CICSLexer.JAVACORE, ErrorSeverity.WARNING);
                    put(CICSLexer.HEAP, ErrorSeverity.WARNING);
                    put(CICSLexer.SNAPTRACE, ErrorSeverity.WARNING);
                    put(CICSLexer.GATHER, ErrorSeverity.WARNING);
                    put(CICSLexer.STACKTRACE, ErrorSeverity.ERROR);
                    put(CICSLexer.GATHERTYPE, ErrorSeverity.ERROR);
                    put(CICSLexer.DIAGNOSTICS, ErrorSeverity.WARNING);
                    put(CICSLexer.TASKID, ErrorSeverity.ERROR);
                    put(CICSLexer.LIBERTY, ErrorSeverity.WARNING);
                    put(CICSLexer.REFRESH, ErrorSeverity.WARNING);
                    put(CICSLexer.OSGI, ErrorSeverity.WARNING);
                    ...
                    put(CICSLexer.PLT, ErrorSeverity.WARNING);

...
export const SETTINGS_CPY_EXTENSIONS: string = "cobol-lsp.cpy-manager.copybook-extensions";
export const SETTINGS_CPY_FILE_ENCODING: string = "cobol-lsp.cpy-manager.copybook-file-encoding";

...
export class LanguageClientService {
    ...
    private createServerOptions(jarPath: string) {
        ...
        return {
            args: ["-Dline.separator=\r\n", "-Ddialect.path='" + this.dialectsPaths + "'", "-Xmx768M", "-jar", jarPath, "pipeEnabled"],
            command: "java",
